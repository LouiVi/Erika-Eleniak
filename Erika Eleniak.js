...
function CreateActionBar()
{
    ...
    //Create title.
    txtBarTitle = app.CreateText( "Erika Eleniak", -1,-1, "Left" );
    txtBarTitle.SetMargins(0,10,0,0,"dip");
    txtBarTitle.SetTextSize( 22 );
    txtBarTitle.SetTextShadow(  5, 2, 2, "#000000" );
...
function CreateDrawer()
{
    ...
    var listItems = "Erika Eleniak::[fa-home],About::[fa-question-circle],New File::[fa-plus]";
...
function lstMenu_OnTouch( title, body, type, index )
{
    ...
    //Handle page changes.
    curMenu = title;
    if( title=="Erika Ekeniak" ) ChangePage( home, title );

...
function File( path, layContent )
{
    ...
    //Create image label.
    var lab = app.CreateText( "Product Picture:" ); 
    ...
    //Create image.
	var img = app.CreateImage( dfltImage, 0.50242, -1 );
	img.imageFile = dfltImage;
    ...
    btnImage.SetTextSize( 16 );
    btnImage.SetTextColor( "#55ef55" );
    btnImage.SetOnTouch( self.btnImage_OnTouch );
    layHoriz.AddChild( btnImage );
    
    //Create 'Notes' label.
    var lab = app.CreateText( "Product Name:" ); 
    ...
    var txtNotes = app.CreateTextEdit( "", 0.827 );
